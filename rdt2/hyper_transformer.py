...
from rdt2.errors import Error, NotFittedError
from rdt2.transformers import (
...
class HyperTransformer:
    ...
    def _validate_transformers(column_name_to_transformer):
        ...
        if invalid_transformers_columns:
            raise Error(
                ...
                'Please assign an rdt2 transformer object to each column name.'
            )
    ...
    def _validate_sdtypes(sdtypes):
        ...
        if unsupported_sdtypes:
            raise Error(
                ...
                'premium sdtype, contact info@sdv.dev about rdt2 Add-Ons.'
            )
    ...
    def update_transformers_by_sdtype(self, sdtype, transformer):
        ...
        Args:
            ...
            transformer (rdt2.transformers.BaseTransformer):
        ...
        if not isinstance(transformer, BaseTransformer) and transformer is not None:
            raise Error('Invalid transformer. Please input an rdt2 transformer object.')
    ...
    def remove_transformers_by_sdtype(self, sdtype):
        ...
        if sdtype not in self._get_supported_sdtypes():
            raise Error(
                ...
                'contact info@sdv.dev about rdt2 Add-Ons.'
            )
