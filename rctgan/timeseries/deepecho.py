...
import pandas as pd
import tqdm
from rctgan.deepecho import PARModel
from rctgan.deepecho.sequences import assemble_sequences

from rctgan.timeseries.base import BaseTimeseriesModel
...
class DeepEchoModel(BaseTimeseriesModel):
    ...
    def _sample(self, context, sequence_length=None):
...
class PAR(DeepEchoModel):
    ...
    def __init__(self, field_names=None, field_types=None, anonymize_fields=None,
                 ...
                 sequence_index=None, segment_size=None,
